    ...
    <section id="book-a-walkthrough" aria-labelledby="cta-heading" className="relative py-20 sm:py-28">
      <Container>
        <div className="relative isolate overflow-hidden rounded-[2rem] bg-night px-6 py-14 sm:px-12 sm:py-20">
          <div aria-hidden className="orb -top-44 -right-28 size-[38rem]" style={{ "--orb": "rgb(101 72 255 / 0.55)" } as CSSProperties} />
          <div aria-hidden className="orb -bottom-52 -left-28 size-[30rem]" style={{ "--orb": "rgb(32 186 158 / 0.28)" } as CSSProperties} />
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.35fr_0.65fr]">
            <div>
              ...
              <div className="mt-9">
                ...
                <ButtonLink href={site.bookingUrl} variant="onDark" size="lg" arrow>
                  {site.bookingLabel}
                </ButtonLink>
              </div>
            </div>
